"""
Unibots 2026 — ORANGE Zone
============================
Assigned zone: ORANGE (right wall, AprilTags 8 & 9).
...
Usage:
  python3 run_orange.py [--port-a /dev/ttyUSB0] [--port-b /dev/ttyUSB1]
...
# ============================================================
TARGET_ZONE     = "orange"
DEPOSIT_HEADING = 270        # face west (back into right wall at x=2000)
