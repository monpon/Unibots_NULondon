"""
Unibots 2026 — PURPLE Zone
============================
Assigned zone: PURPLE (bottom wall, AprilTags 14 & 15).
...
Usage:
  python3 run_purple.py [--port-a /dev/ttyUSB0] [--port-b /dev/ttyUSB1]
...
# ============================================================
TARGET_ZONE     = "purple"
DEPOSIT_HEADING = 180        # face north (back into bottom wall at y=2000)
